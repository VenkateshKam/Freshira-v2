      ...
      <article className="section-py">
        <div className="container max-w-3xl space-y-8 text-sm leading-7 text-muted-foreground">
          <div className="rounded-xl bg-brand-50 p-5 border border-brand-100">
            ...
            <p className="text-brand-950">[To be determined by Freshira India Private Limited]</p>
          ...
          <section>
            ...
            <div className="mt-4 rounded-xl bg-brand-50 p-5 border border-brand-100">
              ...
              <p className="mt-2">Email: [To be confirmed by Freshira]</p>
              <p className="mt-2">Phone: [To be confirmed by Freshira]</p>
      ...
      <article className="section-py">
        <div className="container max-w-3xl space-y-8 text-sm leading-7 text-muted-foreground">
          ...
          <section>
            ...
            <ul className="mt-3 space-y-2 list-disc list-inside">
              <li>Standard orders: Processed within [To be specified] business hours</li>
          ...
          <section>
            ...
            <p className="mt-3 text-brand-950">If you receive a damaged shipment or if your shipment is missing, please contact us within [To be specified] days of the expected delivery date. We may require:</p>
            <ul className="mt-3 space-y-2 list-disc list-inside">
